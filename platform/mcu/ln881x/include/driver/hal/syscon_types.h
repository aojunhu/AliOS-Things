...
#if   defined (LN881x)
    // PORT A ranges GPIOA_0 to GPIOA_20
    #define GPIO_PWIDTH_A 21
#elif defined (LN882x)
 ...
 */
  ...
  typedef enum
  {
      ...
      GPIO_AF_UART1_TX     = 8, 
      GPIO_AF_UART1_RX     = 9, 
      GPIO_AF_SPI_M1_SCK   = 10,
      GPIO_AF_SPI_M1_CS    = 11,
      GPIO_AF_SPI_M1_DIO   = 12,
      GPIO_AF_PWM0         = 13,
      GPIO_AF_PWM1         = 14,
      GPIO_AF_PWM2         = 15,
      GPIO_AF_PWM3         = 16,
...
////////////////////////////////////////  Macros  /////////////////////////////
  ...
  #define IS_GPIO_AF_TYPE(type)    ((type) == GPIO_AF_I2C0_SCL    || \
                                   ...
                                   (type) == GPIO_AF_SPI_M1_SCK  || \
                                   (type) == GPIO_AF_SPI_M1_CS   || \
                                   (type) == GPIO_AF_SPI_M1_DIO  || \
                                   (type) == GPIO_AF_PWM0        || \
                                   (type) == GPIO_AF_PWM1        || \
                                   (type) == GPIO_AF_PWM2        || \
                                   (type) == GPIO_AF_PWM3        || \
