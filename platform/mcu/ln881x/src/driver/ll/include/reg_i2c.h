...
//-----------------------------------------------------------------------------
#ifndef __REG_I2C0_H__
#define __REG_I2C0_H__
...
1��b1 �C issues the STOP_DET interrupt only when it is
addressed.
1��b0 �C issues the STOP_DET irrespective of whether it��s
addressed or not.
...
�� 0: General Call Address �C after issuing a General Call, only
...
#define hwp_i2c0 ((T_HWP_I2C_T*)REG_I2C0_BASE)
#define hwp_i2c1 ((T_HWP_I2C_T*)REG_I2C1_BASE)


__STATIC_INLINE uint32_t i2c_ic_con_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.val;
}

__STATIC_INLINE void i2c_ic_con_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_con.val = value;
}

__STATIC_INLINE void i2c_ic_con_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t rx_fifo_full_hld_ctrl, uint8_t tx_empty_ctrl, uint8_t stop_det_ifaddressed, uint8_t ic_slave_disable, uint8_t ic_restart_en, uint8_t ic_10bitaddr_master, uint8_t ic_10bitaddr_slave, uint8_t speed, uint8_t master_mode)
{
    hwp_i2cX->ic_con.val = (((uint32_t)rx_fifo_full_hld_ctrl << 9) | ((uint32_t)tx_empty_ctrl << 8) | ((uint32_t)stop_det_ifaddressed << 7) | ((uint32_t)ic_slave_disable << 6) | ((uint32_t)ic_restart_en << 5) | ((uint32_t)ic_10bitaddr_master << 4) | ((uint32_t)ic_10bitaddr_slave << 3) | ((uint32_t)speed << 1) | ((uint32_t)master_mode << 0));
}

__STATIC_INLINE void i2c_ic_con_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* rx_fifo_full_hld_ctrl, uint8_t* tx_empty_ctrl, uint8_t* stop_det_ifaddressed, uint8_t* ic_slave_disable, uint8_t* ic_restart_en, uint8_t* ic_10bitaddr_master, uint8_t* ic_10bitaddr_slave, uint8_t* speed, uint8_t* master_mode)
{
    T_I2C_IC_CON localVal = hwp_i2cX->ic_con;
...
__STATIC_INLINE uint8_t i2c_rx_fifo_full_hld_ctrl_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.bit_field.rx_fifo_full_hld_ctrl;
}

__STATIC_INLINE void i2c_rx_fifo_full_hld_ctrl_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t rx_fifo_full_hld_ctrl)
{
    hwp_i2cX->ic_con.bit_field.rx_fifo_full_hld_ctrl = rx_fifo_full_hld_ctrl;
}

__STATIC_INLINE uint8_t i2c_tx_empty_ctrl_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.bit_field.tx_empty_ctrl;
}

__STATIC_INLINE void i2c_tx_empty_ctrl_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t tx_empty_ctrl)
{
    hwp_i2cX->ic_con.bit_field.tx_empty_ctrl = tx_empty_ctrl;
}

__STATIC_INLINE uint8_t i2c_stop_det_ifaddressed_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.bit_field.stop_det_ifaddressed;
}

__STATIC_INLINE void i2c_stop_det_ifaddressed_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t stop_det_ifaddressed)
{
    hwp_i2cX->ic_con.bit_field.stop_det_ifaddressed = stop_det_ifaddressed;
}

__STATIC_INLINE uint8_t i2c_ic_slave_disable_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.bit_field.ic_slave_disable;
}

__STATIC_INLINE void i2c_ic_slave_disable_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t ic_slave_disable)
{
    hwp_i2cX->ic_con.bit_field.ic_slave_disable = ic_slave_disable;
}

__STATIC_INLINE uint8_t i2c_ic_restart_en_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.bit_field.ic_restart_en;
}

__STATIC_INLINE void i2c_ic_restart_en_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t ic_restart_en)
{
    hwp_i2cX->ic_con.bit_field.ic_restart_en = ic_restart_en;
}

__STATIC_INLINE uint8_t i2c_ic_10bitaddr_master_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.bit_field.ic_10bitaddr_master;
}

__STATIC_INLINE void i2c_ic_10bitaddr_master_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t ic_10bitaddr_master)
{
    hwp_i2cX->ic_con.bit_field.ic_10bitaddr_master = ic_10bitaddr_master;
}

__STATIC_INLINE uint8_t i2c_ic_10bitaddr_slave_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.bit_field.ic_10bitaddr_slave;
}

__STATIC_INLINE void i2c_ic_10bitaddr_slave_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t ic_10bitaddr_slave)
{
    hwp_i2cX->ic_con.bit_field.ic_10bitaddr_slave = ic_10bitaddr_slave;
}

__STATIC_INLINE uint8_t i2c_speed_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.bit_field.speed;
}

__STATIC_INLINE void i2c_speed_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t speed)
{
    hwp_i2cX->ic_con.bit_field.speed = speed;
}

__STATIC_INLINE uint8_t i2c_master_mode_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_con.bit_field.master_mode;
}

__STATIC_INLINE void i2c_master_mode_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t master_mode)
{
    hwp_i2cX->ic_con.bit_field.master_mode = master_mode;
}

__STATIC_INLINE uint32_t i2c_ic_tar_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tar.val;
}

__STATIC_INLINE void i2c_ic_tar_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_tar.val = value;
}

__STATIC_INLINE void i2c_ic_tar_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t special, uint8_t gc_or_start, uint16_t tar)
{
    hwp_i2cX->ic_tar.val = (((uint32_t)special << 11) | ((uint32_t)gc_or_start << 10) | ((uint32_t)tar << 0));
}

__STATIC_INLINE void i2c_ic_tar_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* special, uint8_t* gc_or_start, uint16_t* tar)
{
    T_I2C_IC_TAR localVal = hwp_i2cX->ic_tar;
...
__STATIC_INLINE uint8_t i2c_special_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tar.bit_field.special;
}

__STATIC_INLINE void i2c_special_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t special)
{
    hwp_i2cX->ic_tar.bit_field.special = special;
}

__STATIC_INLINE uint8_t i2c_gc_or_start_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tar.bit_field.gc_or_start;
}

__STATIC_INLINE void i2c_gc_or_start_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t gc_or_start)
{
    hwp_i2cX->ic_tar.bit_field.gc_or_start = gc_or_start;
}

__STATIC_INLINE uint16_t i2c_tar_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tar.bit_field.tar;
}

__STATIC_INLINE void i2c_tar_setf(T_HWP_I2C_T * hwp_i2cX, uint16_t tar)
{
    hwp_i2cX->ic_tar.bit_field.tar = tar;
}

__STATIC_INLINE uint32_t i2c_ic_sar_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_sar.val;
}

__STATIC_INLINE void i2c_ic_sar_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_sar.val = value;
}

__STATIC_INLINE void i2c_ic_sar_pack(T_HWP_I2C_T * hwp_i2cX, uint16_t sar)
{
    hwp_i2cX->ic_sar.val = (((uint32_t)sar << 0));
}

__STATIC_INLINE void i2c_ic_sar_unpack(T_HWP_I2C_T * hwp_i2cX, uint16_t* sar)
{
    T_I2C_IC_SAR localVal = hwp_i2cX->ic_sar;

    *sar = localVal.bit_field.sar;
}

__STATIC_INLINE uint16_t i2c_sar_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_sar.bit_field.sar;
}

__STATIC_INLINE void i2c_sar_setf(T_HWP_I2C_T * hwp_i2cX, uint16_t sar)
{
    hwp_i2cX->ic_sar.bit_field.sar = sar;
}

__STATIC_INLINE uint32_t i2c_ic_hs_maddr_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_hs_maddr.val;
}

__STATIC_INLINE void i2c_ic_hs_maddr_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_hs_maddr.val = value;
}

__STATIC_INLINE void i2c_ic_hs_maddr_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t hs_mar)
{
    hwp_i2cX->ic_hs_maddr.val = (((uint32_t)hs_mar << 0));
}

__STATIC_INLINE void i2c_ic_hs_maddr_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* hs_mar)
{
    T_I2C_IC_HS_MADDR localVal = hwp_i2cX->ic_hs_maddr;

    *hs_mar = localVal.bit_field.hs_mar;
}

__STATIC_INLINE uint8_t i2c_hs_mar_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_hs_maddr.bit_field.hs_mar;
}

__STATIC_INLINE void i2c_hs_mar_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t hs_mar)
{
    hwp_i2cX->ic_hs_maddr.bit_field.hs_mar = hs_mar;
}

__STATIC_INLINE uint32_t i2c_ic_data_cmd_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_data_cmd.val;
}

__STATIC_INLINE void i2c_ic_data_cmd_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_data_cmd.val = value;
}

__STATIC_INLINE void i2c_ic_data_cmd_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t restart, uint8_t stop, uint8_t cmd, uint8_t dat)
{
    hwp_i2cX->ic_data_cmd.val = (((uint32_t)restart << 10) | ((uint32_t)stop << 9) | ((uint32_t)cmd << 8) | ((uint32_t)dat << 0));
}

__STATIC_INLINE void i2c_ic_data_cmd_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* first_data_byte, uint8_t* dat)
{
    T_I2C_IC_DATA_CMD localVal = hwp_i2cX->ic_data_cmd;

    *first_data_byte = localVal.bit_field.first_data_byte;
    *dat = localVal.bit_field.dat;
}

__STATIC_INLINE uint8_t i2c_first_data_byte_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_data_cmd.bit_field.first_data_byte;
}

__STATIC_INLINE uint8_t i2c_dat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_data_cmd.bit_field.dat;
}

__STATIC_INLINE uint32_t i2c_ic_ss_scl_hcnt_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_ss_scl_hcnt.val;
}

__STATIC_INLINE void i2c_ic_ss_scl_hcnt_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_ss_scl_hcnt.val = value;
}

__STATIC_INLINE void i2c_ic_ss_scl_hcnt_pack(T_HWP_I2C_T * hwp_i2cX, uint16_t ss_scl_hcnt)
{
    hwp_i2cX->ic_ss_scl_hcnt.val = (((uint32_t)ss_scl_hcnt << 0));
}

__STATIC_INLINE void i2c_ic_ss_scl_hcnt_unpack(T_HWP_I2C_T * hwp_i2cX, uint16_t* ss_scl_hcnt)
{
    T_I2C_IC_SS_SCL_HCNT localVal = hwp_i2cX->ic_ss_scl_hcnt;

    *ss_scl_hcnt = localVal.bit_field.ss_scl_hcnt;
}

__STATIC_INLINE uint16_t i2c_ss_scl_hcnt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_ss_scl_hcnt.bit_field.ss_scl_hcnt;
}

__STATIC_INLINE void i2c_ss_scl_hcnt_setf(T_HWP_I2C_T * hwp_i2cX, uint16_t ss_scl_hcnt)
{
    hwp_i2cX->ic_ss_scl_hcnt.bit_field.ss_scl_hcnt = ss_scl_hcnt;
}

__STATIC_INLINE uint32_t i2c_ic_ss_scl_lcnt_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_ss_scl_lcnt.val;
}

__STATIC_INLINE void i2c_ic_ss_scl_lcnt_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_ss_scl_lcnt.val = value;
}

__STATIC_INLINE void i2c_ic_ss_scl_lcnt_pack(T_HWP_I2C_T * hwp_i2cX, uint16_t ss_scl_lcnt)
{
    hwp_i2cX->ic_ss_scl_lcnt.val = (((uint32_t)ss_scl_lcnt << 0));
}

__STATIC_INLINE void i2c_ic_ss_scl_lcnt_unpack(T_HWP_I2C_T * hwp_i2cX, uint16_t* ss_scl_lcnt)
{
    T_I2C_IC_SS_SCL_LCNT localVal = hwp_i2cX->ic_ss_scl_lcnt;

    *ss_scl_lcnt = localVal.bit_field.ss_scl_lcnt;
}

__STATIC_INLINE uint16_t i2c_ss_scl_lcnt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_ss_scl_lcnt.bit_field.ss_scl_lcnt;
}

__STATIC_INLINE void i2c_ss_scl_lcnt_setf(T_HWP_I2C_T * hwp_i2cX, uint16_t ss_scl_lcnt)
{
    hwp_i2cX->ic_ss_scl_lcnt.bit_field.ss_scl_lcnt = ss_scl_lcnt;
}

__STATIC_INLINE uint32_t i2c_ic_fs_scl_hcnt_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_fs_scl_hcnt.val;
}

__STATIC_INLINE void i2c_ic_fs_scl_hcnt_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_fs_scl_hcnt.val = value;
}

__STATIC_INLINE void i2c_ic_fs_scl_hcnt_pack(T_HWP_I2C_T * hwp_i2cX, uint16_t fs_scl_hcnt)
{
    hwp_i2cX->ic_fs_scl_hcnt.val = (((uint32_t)fs_scl_hcnt << 0));
}

__STATIC_INLINE void i2c_ic_fs_scl_hcnt_unpack(T_HWP_I2C_T * hwp_i2cX, uint16_t* fs_scl_hcnt)
{
    T_I2C_IC_FS_SCL_HCNT localVal = hwp_i2cX->ic_fs_scl_hcnt;

    *fs_scl_hcnt = localVal.bit_field.fs_scl_hcnt;
}

__STATIC_INLINE uint16_t i2c_fs_scl_hcnt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_fs_scl_hcnt.bit_field.fs_scl_hcnt;
}

__STATIC_INLINE void i2c_fs_scl_hcnt_setf(T_HWP_I2C_T * hwp_i2cX, uint16_t fs_scl_hcnt)
{
    hwp_i2cX->ic_fs_scl_hcnt.bit_field.fs_scl_hcnt = fs_scl_hcnt;
}

__STATIC_INLINE uint32_t i2c_ic_fs_scl_lcnt_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_fs_scl_lcnt.val;
}

__STATIC_INLINE void i2c_ic_fs_scl_lcnt_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_fs_scl_lcnt.val = value;
}

__STATIC_INLINE void i2c_ic_fs_scl_lcnt_pack(T_HWP_I2C_T * hwp_i2cX, uint16_t fs_scl_lcnt)
{
    hwp_i2cX->ic_fs_scl_lcnt.val = (((uint32_t)fs_scl_lcnt << 0));
}

__STATIC_INLINE void i2c_ic_fs_scl_lcnt_unpack(T_HWP_I2C_T * hwp_i2cX, uint16_t* fs_scl_lcnt)
{
    T_I2C_IC_FS_SCL_LCNT localVal = hwp_i2cX->ic_fs_scl_lcnt;

    *fs_scl_lcnt = localVal.bit_field.fs_scl_lcnt;
}

__STATIC_INLINE uint16_t i2c_fs_scl_lcnt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_fs_scl_lcnt.bit_field.fs_scl_lcnt;
}

__STATIC_INLINE void i2c_fs_scl_lcnt_setf(T_HWP_I2C_T * hwp_i2cX, uint16_t fs_scl_lcnt)
{
    hwp_i2cX->ic_fs_scl_lcnt.bit_field.fs_scl_lcnt = fs_scl_lcnt;
}

__STATIC_INLINE uint32_t i2c_ic_hs_scl_hcnt_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_hs_scl_hcnt.val;
}

__STATIC_INLINE void i2c_ic_hs_scl_hcnt_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_hs_scl_hcnt.val = value;
}

__STATIC_INLINE void i2c_ic_hs_scl_hcnt_pack(T_HWP_I2C_T * hwp_i2cX, uint16_t hs_scl_hcnt)
{
    hwp_i2cX->ic_hs_scl_hcnt.val = (((uint32_t)hs_scl_hcnt << 0));
}

__STATIC_INLINE void i2c_ic_hs_scl_hcnt_unpack(T_HWP_I2C_T * hwp_i2cX, uint16_t* hs_scl_hcnt)
{
    T_I2C_IC_HS_SCL_HCNT localVal = hwp_i2cX->ic_hs_scl_hcnt;

    *hs_scl_hcnt = localVal.bit_field.hs_scl_hcnt;
}

__STATIC_INLINE uint16_t i2c_hs_scl_hcnt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_hs_scl_hcnt.bit_field.hs_scl_hcnt;
}

__STATIC_INLINE void i2c_hs_scl_hcnt_setf(T_HWP_I2C_T * hwp_i2cX, uint16_t hs_scl_hcnt)
{
    hwp_i2cX->ic_hs_scl_hcnt.bit_field.hs_scl_hcnt = hs_scl_hcnt;
}

__STATIC_INLINE uint32_t i2c_ic_hs_scl_lcnt_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_hs_scl_lcnt.val;
}

__STATIC_INLINE void i2c_ic_hs_scl_lcnt_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_hs_scl_lcnt.val = value;
}

__STATIC_INLINE void i2c_ic_hs_scl_lcnt_pack(T_HWP_I2C_T * hwp_i2cX, uint16_t hs_scl_lcnt)
{
    hwp_i2cX->ic_hs_scl_lcnt.val = (((uint32_t)hs_scl_lcnt << 0));
}

__STATIC_INLINE void i2c_ic_hs_scl_lcnt_unpack(T_HWP_I2C_T * hwp_i2cX, uint16_t* hs_scl_lcnt)
{
    T_I2C_IC_HS_SCL_LCNT localVal = hwp_i2cX->ic_hs_scl_lcnt;

    *hs_scl_lcnt = localVal.bit_field.hs_scl_lcnt;
}

__STATIC_INLINE uint16_t i2c_hs_scl_lcnt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_hs_scl_lcnt.bit_field.hs_scl_lcnt;
}

__STATIC_INLINE void i2c_hs_scl_lcnt_setf(T_HWP_I2C_T * hwp_i2cX, uint16_t hs_scl_lcnt)
{
    hwp_i2cX->ic_hs_scl_lcnt.bit_field.hs_scl_lcnt = hs_scl_lcnt;
}

__STATIC_INLINE uint32_t i2c_ic_intr_stat_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.val;
}

__STATIC_INLINE void i2c_ic_intr_stat_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* scl_stuck_at_low_stat, uint8_t* mst_on_hold_stat, uint8_t* restart_det_stat, uint8_t* gen_call_stat, uint8_t* start_det_stat, uint8_t* stop_det_stat, uint8_t* activity_stat, uint8_t* rx_done_stat, uint8_t* tx_abrt_stat, uint8_t* rd_req_stat, uint8_t* tx_empty_stat, uint8_t* tx_over_stat, uint8_t* rx_full_stat, uint8_t* rx_over_stat, uint8_t* rx_under_stat)
{
    T_I2C_IC_INTR_STAT localVal = hwp_i2cX->ic_intr_stat;
...
__STATIC_INLINE uint8_t i2c_scl_stuck_at_low_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.scl_stuck_at_low_stat;
}

__STATIC_INLINE uint8_t i2c_mst_on_hold_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.mst_on_hold_stat;
}

__STATIC_INLINE uint8_t i2c_restart_det_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.restart_det_stat;
}

__STATIC_INLINE uint8_t i2c_gen_call_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.gen_call_stat;
}

__STATIC_INLINE uint8_t i2c_start_det_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.start_det_stat;
}

__STATIC_INLINE uint8_t i2c_stop_det_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.stop_det_stat;
}

__STATIC_INLINE uint8_t i2c_activity_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.activity_stat;
}

__STATIC_INLINE uint8_t i2c_rx_done_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.rx_done_stat;
}

__STATIC_INLINE uint8_t i2c_tx_abrt_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.tx_abrt_stat;
}

__STATIC_INLINE uint8_t i2c_rd_req_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.rd_req_stat;
}

__STATIC_INLINE uint8_t i2c_tx_empty_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.tx_empty_stat;
}

__STATIC_INLINE uint8_t i2c_tx_over_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.tx_over_stat;
}

__STATIC_INLINE uint8_t i2c_rx_full_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.rx_full_stat;
}

__STATIC_INLINE uint8_t i2c_rx_over_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.rx_over_stat;
}

__STATIC_INLINE uint8_t i2c_rx_under_stat_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_stat.bit_field.rx_under_stat;
}

__STATIC_INLINE uint32_t i2c_ic_intr_mask_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.val;
}

__STATIC_INLINE void i2c_ic_intr_mask_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_intr_mask.val = value;
}

__STATIC_INLINE void i2c_ic_intr_mask_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t restart_det_mask, uint8_t gen_call_mask, uint8_t start_det_mask, uint8_t stop_det_mask, uint8_t activity_mask, uint8_t rx_done_mask, uint8_t tx_abrt_mask, uint8_t rd_req_mask, uint8_t tx_empty_mask, uint8_t tx_over_mask, uint8_t rx_full_mask, uint8_t rx_over_mask, uint8_t rx_under_mask)
{
    hwp_i2cX->ic_intr_mask.val = (((uint32_t)restart_det_mask << 12) | ((uint32_t)gen_call_mask << 11) | ((uint32_t)start_det_mask << 10) | ((uint32_t)stop_det_mask << 9) | ((uint32_t)activity_mask << 8) | ((uint32_t)rx_done_mask << 7) | ((uint32_t)tx_abrt_mask << 6) | ((uint32_t)rd_req_mask << 5) | ((uint32_t)tx_empty_mask << 4) | ((uint32_t)tx_over_mask << 3) | ((uint32_t)rx_full_mask << 2) | ((uint32_t)rx_over_mask << 1) | ((uint32_t)rx_under_mask << 0));
}

__STATIC_INLINE void i2c_ic_intr_mask_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* scl_stuck_at_low_mask, uint8_t* mst_on_hold_mask, uint8_t* restart_det_mask, uint8_t* gen_call_mask, uint8_t* start_det_mask, uint8_t* stop_det_mask, uint8_t* activity_mask, uint8_t* rx_done_mask, uint8_t* tx_abrt_mask, uint8_t* rd_req_mask, uint8_t* tx_empty_mask, uint8_t* tx_over_mask, uint8_t* rx_full_mask, uint8_t* rx_over_mask, uint8_t* rx_under_mask)
{
    T_I2C_IC_INTR_MASK localVal = hwp_i2cX->ic_intr_mask;
...
__STATIC_INLINE uint8_t i2c_scl_stuck_at_low_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.scl_stuck_at_low_mask;
}

__STATIC_INLINE uint8_t i2c_mst_on_hold_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.mst_on_hold_mask;
}

__STATIC_INLINE uint8_t i2c_restart_det_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.restart_det_mask;
}

__STATIC_INLINE void i2c_restart_det_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t restart_det_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.restart_det_mask = restart_det_mask;
}

__STATIC_INLINE uint8_t i2c_gen_call_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.gen_call_mask;
}

__STATIC_INLINE void i2c_gen_call_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t gen_call_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.gen_call_mask = gen_call_mask;
}

__STATIC_INLINE uint8_t i2c_start_det_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.start_det_mask;
}

__STATIC_INLINE void i2c_start_det_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t start_det_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.start_det_mask = start_det_mask;
}

__STATIC_INLINE uint8_t i2c_stop_det_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.stop_det_mask;
}

__STATIC_INLINE void i2c_stop_det_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t stop_det_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.stop_det_mask = stop_det_mask;
}

__STATIC_INLINE uint8_t i2c_activity_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.activity_mask;
}

__STATIC_INLINE void i2c_activity_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t activity_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.activity_mask = activity_mask;
}

__STATIC_INLINE uint8_t i2c_rx_done_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.rx_done_mask;
}

__STATIC_INLINE void i2c_rx_done_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t rx_done_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.rx_done_mask = rx_done_mask;
}

__STATIC_INLINE uint8_t i2c_tx_abrt_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.tx_abrt_mask;
}

__STATIC_INLINE void i2c_tx_abrt_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t tx_abrt_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.tx_abrt_mask = tx_abrt_mask;
}

__STATIC_INLINE uint8_t i2c_rd_req_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.rd_req_mask;
}

__STATIC_INLINE void i2c_rd_req_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t rd_req_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.rd_req_mask = rd_req_mask;
}

__STATIC_INLINE uint8_t i2c_tx_empty_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.tx_empty_mask;
}

__STATIC_INLINE void i2c_tx_empty_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t tx_empty_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.tx_empty_mask = tx_empty_mask;
}

__STATIC_INLINE uint8_t i2c_tx_over_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.tx_over_mask;
}

__STATIC_INLINE void i2c_tx_over_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t tx_over_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.tx_over_mask = tx_over_mask;
}

__STATIC_INLINE uint8_t i2c_rx_full_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.rx_full_mask;
}

__STATIC_INLINE void i2c_rx_full_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t rx_full_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.rx_full_mask = rx_full_mask;
}

__STATIC_INLINE uint8_t i2c_rx_over_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.rx_over_mask;
}

__STATIC_INLINE void i2c_rx_over_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t rx_over_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.rx_over_mask = rx_over_mask;
}

__STATIC_INLINE uint8_t i2c_rx_under_mask_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_intr_mask.bit_field.rx_under_mask;
}

__STATIC_INLINE void i2c_rx_under_mask_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t rx_under_mask)
{
    hwp_i2cX->ic_intr_mask.bit_field.rx_under_mask = rx_under_mask;
}

__STATIC_INLINE uint32_t i2c_ic_raw_intr_stat_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.val;
}

__STATIC_INLINE void i2c_ic_raw_intr_stat_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* scl_stuck_at_low_raw, uint8_t* mst_on_hold_raw, uint8_t* restart_det_raw, uint8_t* gen_call_raw, uint8_t* start_det_raw, uint8_t* stop_det_raw, uint8_t* activity_raw, uint8_t* rx_done_raw, uint8_t* tx_abrt_raw, uint8_t* rd_req_raw, uint8_t* tx_empty_raw, uint8_t* tx_over_raw, uint8_t* rx_full_raw, uint8_t* rx_over_raw, uint8_t* rx_under_raw)
{
    T_I2C_IC_RAW_INTR_STAT localVal = hwp_i2cX->ic_raw_intr_stat;
...
__STATIC_INLINE uint8_t i2c_scl_stuck_at_low_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.scl_stuck_at_low_raw;
}

__STATIC_INLINE uint8_t i2c_mst_on_hold_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.mst_on_hold_raw;
}

__STATIC_INLINE uint8_t i2c_restart_det_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.restart_det_raw;
}

__STATIC_INLINE uint8_t i2c_gen_call_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.gen_call_raw;
}

__STATIC_INLINE uint8_t i2c_start_det_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.start_det_raw;
}

__STATIC_INLINE uint8_t i2c_stop_det_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.stop_det_raw;
}

__STATIC_INLINE uint8_t i2c_activity_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.activity_raw;
}

__STATIC_INLINE uint8_t i2c_rx_done_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.rx_done_raw;
}

__STATIC_INLINE uint8_t i2c_tx_abrt_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.tx_abrt_raw;
}

__STATIC_INLINE uint8_t i2c_rd_req_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.rd_req_raw;
}

__STATIC_INLINE uint8_t i2c_tx_empty_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.tx_empty_raw;
}

__STATIC_INLINE uint8_t i2c_tx_over_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.tx_over_raw;
}

__STATIC_INLINE uint8_t i2c_rx_full_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.rx_full_raw;
}

__STATIC_INLINE uint8_t i2c_rx_over_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.rx_over_raw;
}

__STATIC_INLINE uint8_t i2c_rx_under_raw_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_raw_intr_stat.bit_field.rx_under_raw;
}

__STATIC_INLINE uint32_t i2c_ic_rx_tl_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_rx_tl.val;
}

__STATIC_INLINE void i2c_ic_rx_tl_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_rx_tl.val = value;
}

__STATIC_INLINE void i2c_ic_rx_tl_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t rx_tl)
{
    hwp_i2cX->ic_rx_tl.val = (((uint32_t)rx_tl << 0));
}

__STATIC_INLINE void i2c_ic_rx_tl_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* rx_tl)
{
    T_I2C_IC_RX_TL localVal = hwp_i2cX->ic_rx_tl;

    *rx_tl = localVal.bit_field.rx_tl;
}

__STATIC_INLINE uint8_t i2c_rx_tl_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_rx_tl.bit_field.rx_tl;
}

__STATIC_INLINE void i2c_rx_tl_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t rx_tl)
{
    hwp_i2cX->ic_rx_tl.bit_field.rx_tl = rx_tl;
}

__STATIC_INLINE uint32_t i2c_ic_tx_tl_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_tl.val;
}

__STATIC_INLINE void i2c_ic_tx_tl_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_tx_tl.val = value;
}

__STATIC_INLINE void i2c_ic_tx_tl_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t tx_tl)
{
    hwp_i2cX->ic_tx_tl.val = (((uint32_t)tx_tl << 0));
}

__STATIC_INLINE void i2c_ic_tx_tl_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* tx_tl)
{
    T_I2C_IC_TX_TL localVal = hwp_i2cX->ic_tx_tl;

    *tx_tl = localVal.bit_field.tx_tl;
}

__STATIC_INLINE uint8_t i2c_tx_tl_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_tl.bit_field.tx_tl;
}

__STATIC_INLINE void i2c_tx_tl_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t tx_tl)
{
    hwp_i2cX->ic_tx_tl.bit_field.tx_tl = tx_tl;
}

__STATIC_INLINE uint32_t i2c_ic_clr_intr_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_intr.val;
}

__STATIC_INLINE void i2c_ic_clr_intr_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_intr)
{
    T_I2C_IC_CLR_INTR localVal = hwp_i2cX->ic_clr_intr;

    *clr_intr = localVal.bit_field.clr_intr;
}

__STATIC_INLINE uint8_t i2c_clr_intr_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_intr.bit_field.clr_intr;
}

__STATIC_INLINE uint32_t i2c_ic_clr_rx_under_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_rx_under.val;
}

__STATIC_INLINE void i2c_ic_clr_rx_under_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_rx_under)
{
    T_I2C_IC_CLR_RX_UNDER localVal = hwp_i2cX->ic_clr_rx_under;

    *clr_rx_under = localVal.bit_field.clr_rx_under;
}

__STATIC_INLINE uint8_t i2c_clr_rx_under_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_rx_under.bit_field.clr_rx_under;
}

__STATIC_INLINE uint32_t i2c_ic_clr_rx_over_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_rx_over.val;
}

__STATIC_INLINE void i2c_ic_clr_rx_over_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_rx_over)
{
    T_I2C_IC_CLR_RX_OVER localVal = hwp_i2cX->ic_clr_rx_over;

    *clr_rx_over = localVal.bit_field.clr_rx_over;
}

__STATIC_INLINE uint8_t i2c_clr_rx_over_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_rx_over.bit_field.clr_rx_over;
}

__STATIC_INLINE uint32_t i2c_ic_clr_tx_over_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_tx_over.val;
}

__STATIC_INLINE void i2c_ic_clr_tx_over_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_tx_over)
{
    T_I2C_IC_CLR_TX_OVER localVal = hwp_i2cX->ic_clr_tx_over;

    *clr_tx_over = localVal.bit_field.clr_tx_over;
}

__STATIC_INLINE uint8_t i2c_clr_tx_over_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_tx_over.bit_field.clr_tx_over;
}

__STATIC_INLINE uint32_t i2c_ic_clr_rd_req_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_rd_req.val;
}

__STATIC_INLINE void i2c_ic_clr_rd_req_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_rd_req)
{
    T_I2C_IC_CLR_RD_REQ localVal = hwp_i2cX->ic_clr_rd_req;

    *clr_rd_req = localVal.bit_field.clr_rd_req;
}

__STATIC_INLINE uint8_t i2c_clr_rd_req_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_rd_req.bit_field.clr_rd_req;
}

__STATIC_INLINE uint32_t i2c_ic_clr_tx_abrt_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_tx_abrt.val;
}

__STATIC_INLINE void i2c_ic_clr_tx_abrt_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_tx_abrt)
{
    T_I2C_IC_CLR_TX_ABRT localVal = hwp_i2cX->ic_clr_tx_abrt;

    *clr_tx_abrt = localVal.bit_field.clr_tx_abrt;
}

__STATIC_INLINE uint8_t i2c_clr_tx_abrt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_tx_abrt.bit_field.clr_tx_abrt;
}

__STATIC_INLINE uint32_t i2c_ic_clr_rx_done_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_rx_done.val;
}

__STATIC_INLINE void i2c_ic_clr_rx_done_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_rx_done)
{
    T_I2C_IC_CLR_RX_DONE localVal = hwp_i2cX->ic_clr_rx_done;

    *clr_rx_done = localVal.bit_field.clr_rx_done;
}

__STATIC_INLINE uint8_t i2c_clr_rx_done_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_rx_done.bit_field.clr_rx_done;
}

__STATIC_INLINE uint32_t i2c_ic_clr_activity_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_activity.val;
}

__STATIC_INLINE void i2c_ic_clr_activity_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_activity)
{
    T_I2C_IC_CLR_ACTIVITY localVal = hwp_i2cX->ic_clr_activity;

    *clr_activity = localVal.bit_field.clr_activity;
}

__STATIC_INLINE uint8_t i2c_clr_activity_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_activity.bit_field.clr_activity;
}

__STATIC_INLINE uint32_t i2c_ic_clr_stop_det_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_stop_det.val;
}

__STATIC_INLINE void i2c_ic_clr_stop_det_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_stop_det)
{
    T_I2C_IC_CLR_STOP_DET localVal = hwp_i2cX->ic_clr_stop_det;

    *clr_stop_det = localVal.bit_field.clr_stop_det;
}

__STATIC_INLINE uint8_t i2c_clr_stop_det_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_stop_det.bit_field.clr_stop_det;
}

__STATIC_INLINE uint32_t i2c_ic_clr_start_det_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_start_det.val;
}

__STATIC_INLINE void i2c_ic_clr_start_det_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_start_det)
{
    T_I2C_IC_CLR_START_DET localVal = hwp_i2cX->ic_clr_start_det;

    *clr_start_det = localVal.bit_field.clr_start_det;
}

__STATIC_INLINE uint8_t i2c_clr_start_det_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_start_det.bit_field.clr_start_det;
}

__STATIC_INLINE uint32_t i2c_ic_clr_gen_call_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_gen_call.val;
}

__STATIC_INLINE void i2c_ic_clr_gen_call_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_gen_call)
{
    T_I2C_IC_CLR_GEN_CALL localVal = hwp_i2cX->ic_clr_gen_call;

    *clr_gen_call = localVal.bit_field.clr_gen_call;
}

__STATIC_INLINE uint8_t i2c_clr_gen_call_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_gen_call.bit_field.clr_gen_call;
}

__STATIC_INLINE uint32_t i2c_ic_enable_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_enable.val;
}

__STATIC_INLINE void i2c_ic_enable_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_enable.val = value;
}

__STATIC_INLINE void i2c_ic_enable_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t abort, uint8_t enable)
{
    hwp_i2cX->ic_enable.val = (((uint32_t)abort << 1) | ((uint32_t)enable << 0));
}

__STATIC_INLINE void i2c_ic_enable_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* abort, uint8_t* enable)
{
    T_I2C_IC_ENABLE localVal = hwp_i2cX->ic_enable;

    *abort = localVal.bit_field.abort;
    *enable = localVal.bit_field.enable;
}

__STATIC_INLINE uint8_t i2c_abort_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_enable.bit_field.abort;
}

__STATIC_INLINE void i2c_abort_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t abort)
{
    hwp_i2cX->ic_enable.bit_field.abort = abort;
}

__STATIC_INLINE uint8_t i2c_enable_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_enable.bit_field.enable;
}

__STATIC_INLINE void i2c_enable_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t enable)
{
    hwp_i2cX->ic_enable.bit_field.enable = enable;
}

__STATIC_INLINE uint32_t i2c_ic_status_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.val;
}

__STATIC_INLINE void i2c_ic_status_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* smbus_alert_status, uint8_t* smbus_suspend_status, uint8_t* smbus_slave_addr_resolved, uint8_t* smbus_slave_addr_valid, uint8_t* smbus_quick_cmd_bit, uint8_t* sda_stuck_not_recovered, uint8_t* slv_hold_rx_fifo_full, uint8_t* slv_hold_tx_fifo_empty, uint8_t* mst_hold_rx_fifo_full, uint8_t* mst_hold_tx_fifo_empty, uint8_t* slv_activity, uint8_t* mst_activity, uint8_t* rff, uint8_t* rfne, uint8_t* tfe, uint8_t* tfnf, uint8_t* activity)
{
    T_I2C_IC_STATUS localVal = hwp_i2cX->ic_status;
...
__STATIC_INLINE uint8_t i2c_smbus_alert_status_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.smbus_alert_status;
}

__STATIC_INLINE uint8_t i2c_smbus_suspend_status_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.smbus_suspend_status;
}

__STATIC_INLINE uint8_t i2c_smbus_slave_addr_resolved_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.smbus_slave_addr_resolved;
}

__STATIC_INLINE uint8_t i2c_smbus_slave_addr_valid_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.smbus_slave_addr_valid;
}

__STATIC_INLINE uint8_t i2c_smbus_quick_cmd_bit_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.smbus_quick_cmd_bit;
}

__STATIC_INLINE uint8_t i2c_sda_stuck_not_recovered_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.sda_stuck_not_recovered;
}

__STATIC_INLINE uint8_t i2c_slv_hold_rx_fifo_full_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.slv_hold_rx_fifo_full;
}

__STATIC_INLINE uint8_t i2c_slv_hold_tx_fifo_empty_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.slv_hold_tx_fifo_empty;
}

__STATIC_INLINE uint8_t i2c_mst_hold_rx_fifo_full_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.mst_hold_rx_fifo_full;
}

__STATIC_INLINE uint8_t i2c_mst_hold_tx_fifo_empty_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.mst_hold_tx_fifo_empty;
}

__STATIC_INLINE uint8_t i2c_slv_activity_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.slv_activity;
}

__STATIC_INLINE uint8_t i2c_mst_activity_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.mst_activity;
}

__STATIC_INLINE uint8_t i2c_rff_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.rff;
}

__STATIC_INLINE uint8_t i2c_rfne_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.rfne;
}

__STATIC_INLINE uint8_t i2c_tfe_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.tfe;
}

__STATIC_INLINE uint8_t i2c_tfnf_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.tfnf;
}

__STATIC_INLINE uint8_t i2c_activity_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_status.bit_field.activity;
}

__STATIC_INLINE uint32_t i2c_ic_txflr_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_txflr.val;
}

__STATIC_INLINE void i2c_ic_txflr_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* txflr)
{
    T_I2C_IC_TXFLR localVal = hwp_i2cX->ic_txflr;

    *txflr = localVal.bit_field.txflr;
}

__STATIC_INLINE uint8_t i2c_txflr_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_txflr.bit_field.txflr;
}

__STATIC_INLINE uint32_t i2c_ic_rxflr_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_rxflr.val;
}

__STATIC_INLINE void i2c_ic_rxflr_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* rxflr)
{
    T_I2C_IC_RXFLR localVal = hwp_i2cX->ic_rxflr;

    *rxflr = localVal.bit_field.rxflr;
}

__STATIC_INLINE uint8_t i2c_rxflr_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_rxflr.bit_field.rxflr;
}

__STATIC_INLINE uint32_t i2c_ic_sda_hold_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_sda_hold.val;
}

__STATIC_INLINE void i2c_ic_sda_hold_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_sda_hold.val = value;
}

__STATIC_INLINE void i2c_ic_sda_hold_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t ic_sda_rx_hold, uint16_t ic_sda_tx_hold)
{
    hwp_i2cX->ic_sda_hold.val = (((uint32_t)ic_sda_rx_hold << 16) | ((uint32_t)ic_sda_tx_hold << 0));
}

__STATIC_INLINE void i2c_ic_sda_hold_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* ic_sda_rx_hold, uint16_t* ic_sda_tx_hold)
{
    T_I2C_IC_SDA_HOLD localVal = hwp_i2cX->ic_sda_hold;

    *ic_sda_rx_hold = localVal.bit_field.ic_sda_rx_hold;
    *ic_sda_tx_hold = localVal.bit_field.ic_sda_tx_hold;
}

__STATIC_INLINE uint8_t i2c_ic_sda_rx_hold_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_sda_hold.bit_field.ic_sda_rx_hold;
}

__STATIC_INLINE void i2c_ic_sda_rx_hold_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t ic_sda_rx_hold)
{
    hwp_i2cX->ic_sda_hold.bit_field.ic_sda_rx_hold = ic_sda_rx_hold;
}

__STATIC_INLINE uint16_t i2c_ic_sda_tx_hold_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_sda_hold.bit_field.ic_sda_tx_hold;
}

__STATIC_INLINE void i2c_ic_sda_tx_hold_setf(T_HWP_I2C_T * hwp_i2cX, uint16_t ic_sda_tx_hold)
{
    hwp_i2cX->ic_sda_hold.bit_field.ic_sda_tx_hold = ic_sda_tx_hold;
}

__STATIC_INLINE uint32_t i2c_ic_tx_abrt_source_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.val;
}

__STATIC_INLINE void i2c_ic_tx_abrt_source_unpack(T_HWP_I2C_T * hwp_i2cX, uint16_t* tx_flush_cnt, uint8_t* abrt_device_write, uint8_t* abrt_device_slvaddr_noack, uint8_t* abrt_device_noack, uint8_t* abrt_sda_stuck_at_low, uint8_t* abrt_user_abrt, uint8_t* abrt_slvrd_intx, uint8_t* abrt_slv_arblost, uint8_t* abrt_slvflush_txfifo, uint8_t* arb_lost, uint8_t* abrt_master_dis, uint8_t* abrt_10b_rd_norstrt, uint8_t* abrt_sbyte_norstrt, uint8_t* abrt_hs_norstrt, uint8_t* abrt_sbyte_ackdet, uint8_t* abrt_hs_ackdet, uint8_t* abrt_gcall_read, uint8_t* abrt_gcall_noack, uint8_t* abrt_txdata_noack, uint8_t* abrt_10addr2_noack, uint8_t* abrt_10addr1_noack, uint8_t* abrt_7baddr_noack)
{
    T_I2C_IC_TX_ABRT_SOURCE localVal = hwp_i2cX->ic_tx_abrt_source;
...
__STATIC_INLINE uint16_t i2c_tx_flush_cnt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.tx_flush_cnt;
}

__STATIC_INLINE uint8_t i2c_abrt_device_write_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_device_write;
}

__STATIC_INLINE uint8_t i2c_abrt_device_slvaddr_noack_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_device_slvaddr_noack;
}

__STATIC_INLINE uint8_t i2c_abrt_device_noack_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_device_noack;
}

__STATIC_INLINE uint8_t i2c_abrt_sda_stuck_at_low_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_sda_stuck_at_low;
}

__STATIC_INLINE uint8_t i2c_abrt_user_abrt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_user_abrt;
}

__STATIC_INLINE uint8_t i2c_abrt_slvrd_intx_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_slvrd_intx;
}

__STATIC_INLINE uint8_t i2c_abrt_slv_arblost_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_slv_arblost;
}

__STATIC_INLINE uint8_t i2c_abrt_slvflush_txfifo_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_slvflush_txfifo;
}

__STATIC_INLINE uint8_t i2c_arb_lost_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.arb_lost;
}

__STATIC_INLINE uint8_t i2c_abrt_master_dis_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_master_dis;
}

__STATIC_INLINE uint8_t i2c_abrt_10b_rd_norstrt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_10b_rd_norstrt;
}

__STATIC_INLINE uint8_t i2c_abrt_sbyte_norstrt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_sbyte_norstrt;
}

__STATIC_INLINE uint8_t i2c_abrt_hs_norstrt_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_hs_norstrt;
}

__STATIC_INLINE uint8_t i2c_abrt_sbyte_ackdet_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_sbyte_ackdet;
}

__STATIC_INLINE uint8_t i2c_abrt_hs_ackdet_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_hs_ackdet;
}

__STATIC_INLINE uint8_t i2c_abrt_gcall_read_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_gcall_read;
}

__STATIC_INLINE uint8_t i2c_abrt_gcall_noack_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_gcall_noack;
}

__STATIC_INLINE uint8_t i2c_abrt_txdata_noack_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_txdata_noack;
}

__STATIC_INLINE uint8_t i2c_abrt_10addr2_noack_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_10addr2_noack;
}

__STATIC_INLINE uint8_t i2c_abrt_10addr1_noack_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_10addr1_noack;
}

__STATIC_INLINE uint8_t i2c_abrt_7baddr_noack_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_tx_abrt_source.bit_field.abrt_7baddr_noack;
}

__STATIC_INLINE uint32_t i2c_ic_slv_data_nack_only_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_slv_data_nack_only.val;
}

__STATIC_INLINE void i2c_ic_slv_data_nack_only_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_slv_data_nack_only.val = value;
}

__STATIC_INLINE void i2c_ic_slv_data_nack_only_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t nack)
{
    hwp_i2cX->ic_slv_data_nack_only.val = (((uint32_t)nack << 0));
}

__STATIC_INLINE void i2c_ic_slv_data_nack_only_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* nack)
{
    T_I2C_IC_SLV_DATA_NACK_ONLY localVal = hwp_i2cX->ic_slv_data_nack_only;

    *nack = localVal.bit_field.nack;
}

__STATIC_INLINE uint8_t i2c_nack_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_slv_data_nack_only.bit_field.nack;
}

__STATIC_INLINE void i2c_nack_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t nack)
{
    hwp_i2cX->ic_slv_data_nack_only.bit_field.nack = nack;
}

__STATIC_INLINE uint32_t i2c_ic_dma_cr_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_dma_cr.val;
}

__STATIC_INLINE void i2c_ic_dma_cr_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_dma_cr.val = value;
}

__STATIC_INLINE void i2c_ic_dma_cr_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t tdmae, uint8_t rdmae)
{
    hwp_i2cX->ic_dma_cr.val = (((uint32_t)tdmae << 1) | ((uint32_t)rdmae << 0));
}

__STATIC_INLINE void i2c_ic_dma_cr_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* tdmae, uint8_t* rdmae)
{
    T_I2C_IC_DMA_CR localVal = hwp_i2cX->ic_dma_cr;

    *tdmae = localVal.bit_field.tdmae;
    *rdmae = localVal.bit_field.rdmae;
}

__STATIC_INLINE uint8_t i2c_tdmae_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_dma_cr.bit_field.tdmae;
}

__STATIC_INLINE void i2c_tdmae_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t tdmae)
{
    hwp_i2cX->ic_dma_cr.bit_field.tdmae = tdmae;
}

__STATIC_INLINE uint8_t i2c_rdmae_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_dma_cr.bit_field.rdmae;
}

__STATIC_INLINE void i2c_rdmae_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t rdmae)
{
    hwp_i2cX->ic_dma_cr.bit_field.rdmae = rdmae;
}

__STATIC_INLINE uint32_t i2c_ic_dma_tdlr_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_dma_tdlr.val;
}

__STATIC_INLINE void i2c_ic_dma_tdlr_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_dma_tdlr.val = value;
}

__STATIC_INLINE void i2c_ic_dma_tdlr_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t dmatdl)
{
    hwp_i2cX->ic_dma_tdlr.val = (((uint32_t)dmatdl << 0));
}

__STATIC_INLINE void i2c_ic_dma_tdlr_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* dmatdl)
{
    T_I2C_IC_DMA_TDLR localVal = hwp_i2cX->ic_dma_tdlr;

    *dmatdl = localVal.bit_field.dmatdl;
}

__STATIC_INLINE uint8_t i2c_dmatdl_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_dma_tdlr.bit_field.dmatdl;
}

__STATIC_INLINE void i2c_dmatdl_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t dmatdl)
{
    hwp_i2cX->ic_dma_tdlr.bit_field.dmatdl = dmatdl;
}

__STATIC_INLINE uint32_t i2c_ic_dma_rdlr_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_dma_rdlr.val;
}

__STATIC_INLINE void i2c_ic_dma_rdlr_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_dma_rdlr.val = value;
}

__STATIC_INLINE void i2c_ic_dma_rdlr_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t dmardl)
{
    hwp_i2cX->ic_dma_rdlr.val = (((uint32_t)dmardl << 0));
}

__STATIC_INLINE void i2c_ic_dma_rdlr_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* dmardl)
{
    T_I2C_IC_DMA_RDLR localVal = hwp_i2cX->ic_dma_rdlr;

    *dmardl = localVal.bit_field.dmardl;
}

__STATIC_INLINE uint8_t i2c_dmardl_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_dma_rdlr.bit_field.dmardl;
}

__STATIC_INLINE void i2c_dmardl_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t dmardl)
{
    hwp_i2cX->ic_dma_rdlr.bit_field.dmardl = dmardl;
}

__STATIC_INLINE uint32_t i2c_ic_sda_setup_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_sda_setup.val;
}

__STATIC_INLINE void i2c_ic_sda_setup_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_sda_setup.val = value;
}

__STATIC_INLINE void i2c_ic_sda_setup_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t sda_setup)
{
    hwp_i2cX->ic_sda_setup.val = (((uint32_t)sda_setup << 0));
}

__STATIC_INLINE void i2c_ic_sda_setup_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* sda_setup)
{
    T_I2C_IC_SDA_SETUP localVal = hwp_i2cX->ic_sda_setup;

    *sda_setup = localVal.bit_field.sda_setup;
}

__STATIC_INLINE uint8_t i2c_sda_setup_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_sda_setup.bit_field.sda_setup;
}

__STATIC_INLINE void i2c_sda_setup_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t sda_setup)
{
    hwp_i2cX->ic_sda_setup.bit_field.sda_setup = sda_setup;
}

__STATIC_INLINE uint32_t i2c_ic_ack_general_call_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_ack_general_call.val;
}

__STATIC_INLINE void i2c_ic_ack_general_call_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_ack_general_call.val = value;
}

__STATIC_INLINE void i2c_ic_ack_general_call_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t ack_gen_call)
{
    hwp_i2cX->ic_ack_general_call.val = (((uint32_t)ack_gen_call << 0));
}

__STATIC_INLINE void i2c_ic_ack_general_call_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* ack_gen_call)
{
    T_I2C_IC_ACK_GENERAL_CALL localVal = hwp_i2cX->ic_ack_general_call;

    *ack_gen_call = localVal.bit_field.ack_gen_call;
}

__STATIC_INLINE uint8_t i2c_ack_gen_call_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_ack_general_call.bit_field.ack_gen_call;
}

__STATIC_INLINE void i2c_ack_gen_call_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t ack_gen_call)
{
    hwp_i2cX->ic_ack_general_call.bit_field.ack_gen_call = ack_gen_call;
}

__STATIC_INLINE uint32_t i2c_ic_enable_status_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_enable_status.val;
}

__STATIC_INLINE void i2c_ic_enable_status_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* slv_rx_data_lost, uint8_t* slv_disabled_while_busy, uint8_t* ic_en)
{
    T_I2C_IC_ENABLE_STATUS localVal = hwp_i2cX->ic_enable_status;
...
__STATIC_INLINE uint8_t i2c_slv_rx_data_lost_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_enable_status.bit_field.slv_rx_data_lost;
}

__STATIC_INLINE uint8_t i2c_slv_disabled_while_busy_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_enable_status.bit_field.slv_disabled_while_busy;
}

__STATIC_INLINE uint8_t i2c_ic_en_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_enable_status.bit_field.ic_en;
}

__STATIC_INLINE uint32_t i2c_ic_fs_spklen_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_fs_spklen.val;
}

__STATIC_INLINE void i2c_ic_fs_spklen_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_fs_spklen.val = value;
}

__STATIC_INLINE void i2c_ic_fs_spklen_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t fs_spklen)
{
    hwp_i2cX->ic_fs_spklen.val = (((uint32_t)fs_spklen << 0));
}

__STATIC_INLINE void i2c_ic_fs_spklen_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* fs_spklen)
{
    T_I2C_IC_FS_SPKLEN localVal = hwp_i2cX->ic_fs_spklen;

    *fs_spklen = localVal.bit_field.fs_spklen;
}

__STATIC_INLINE uint8_t i2c_fs_spklen_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_fs_spklen.bit_field.fs_spklen;
}

__STATIC_INLINE void i2c_fs_spklen_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t fs_spklen)
{
    hwp_i2cX->ic_fs_spklen.bit_field.fs_spklen = fs_spklen;
}

__STATIC_INLINE uint32_t i2c_ic_hs_spklen_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_hs_spklen.val;
}

__STATIC_INLINE void i2c_ic_hs_spklen_set(T_HWP_I2C_T * hwp_i2cX, uint32_t value)
{
    hwp_i2cX->ic_hs_spklen.val = value;
}

__STATIC_INLINE void i2c_ic_hs_spklen_pack(T_HWP_I2C_T * hwp_i2cX, uint8_t hs_spklen)
{
    hwp_i2cX->ic_hs_spklen.val = (((uint32_t)hs_spklen << 0));
}

__STATIC_INLINE void i2c_ic_hs_spklen_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* hs_spklen)
{
    T_I2C_IC_HS_SPKLEN localVal = hwp_i2cX->ic_hs_spklen;

    *hs_spklen = localVal.bit_field.hs_spklen;
}

__STATIC_INLINE uint8_t i2c_hs_spklen_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_hs_spklen.bit_field.hs_spklen;
}

__STATIC_INLINE void i2c_hs_spklen_setf(T_HWP_I2C_T * hwp_i2cX, uint8_t hs_spklen)
{
    hwp_i2cX->ic_hs_spklen.bit_field.hs_spklen = hs_spklen;
}

__STATIC_INLINE uint32_t i2c_ic_clr_restart_det_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_restart_det.val;
}

__STATIC_INLINE void i2c_ic_clr_restart_det_unpack(T_HWP_I2C_T * hwp_i2cX, uint8_t* clr_restart_det)
{
    T_I2C_IC_CLR_RESTART_DET localVal = hwp_i2cX->ic_clr_restart_det;

    *clr_restart_det = localVal.bit_field.clr_restart_det;
}

__STATIC_INLINE uint8_t i2c_clr_restart_det_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_clr_restart_det.bit_field.clr_restart_det;
}

__STATIC_INLINE uint32_t i2c_ic_comp_param_1_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_comp_param_1.val;
}

__STATIC_INLINE uint32_t i2c_ic_comp_version_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_comp_version.val;
}

__STATIC_INLINE void i2c_ic_comp_version_unpack(T_HWP_I2C_T * hwp_i2cX, uint32_t* comp_version)
{
    T_I2C_IC_COMP_VERSION localVal = hwp_i2cX->ic_comp_version;

    *comp_version = localVal.bit_field.comp_version;
}

__STATIC_INLINE uint32_t i2c_comp_version_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_comp_version.bit_field.comp_version;
}

__STATIC_INLINE uint32_t i2c_ic_comp_type_get(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_comp_type.val;
}

__STATIC_INLINE void i2c_ic_comp_type_unpack(T_HWP_I2C_T * hwp_i2cX, uint32_t* comp_type)
{
    T_I2C_IC_COMP_TYPE localVal = hwp_i2cX->ic_comp_type;

    *comp_type = localVal.bit_field.comp_type;
}

__STATIC_INLINE uint32_t i2c_comp_type_getf(T_HWP_I2C_T * hwp_i2cX)
{
    return hwp_i2cX->ic_comp_type.bit_field.comp_type;
}
#endif
