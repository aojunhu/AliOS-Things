...
typedef union
{
    ...
    struct
    {
        uint32_t                            ser :  3; /* 2: 0, Slave Select Enable Flag. Each bit in this register corresponds to a
...
typedef struct
{
    ...
    volatile                      T_SPIM_IDR                            idr; /* 0x58,    RO, 0x000000A8,                             NA*/
...
#define hwp_spim ((T_HWP_SPIM_T*)REG_SPI_M0_BASE)
