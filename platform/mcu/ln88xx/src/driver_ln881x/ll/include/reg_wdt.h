...
001 每 4 pclk cycles
010 每 8 pclk cycles
011 每 16 pclk cycles
100 每 32 pclk cycles
101 每 64 pclk cycles
110 每 128 pclk cycles
111 每 256 pclk cycles*/
...
__STATIC_INLINE uint32_t wdt_wdt_comp_version_0_get(void)
{
    return hwp_wdt->wdt_comp_version_0.val;
}

__STATIC_INLINE void wdt_wdt_comp_version_0_unpack(uint32_t* wdtcomponentversion0)
{
    T_WDT_WDT_COMP_VERSION_0 localVal = hwp_wdt->wdt_comp_version_0;

    *wdtcomponentversion0 = localVal.bit_field.wdtcomponentversion0;
}

__STATIC_INLINE uint32_t wdt_wdtcomponentversion0_getf(void)
{
    return hwp_wdt->wdt_comp_version_0.bit_field.wdtcomponentversion0;
}
...
__STATIC_INLINE uint32_t wdt_wdt_comp_version_1_get(void)
{
    return hwp_wdt->wdt_comp_version_1.val;
}

__STATIC_INLINE void wdt_wdt_comp_version_1_unpack(uint32_t* wdtcomponentversion1)
{
    T_WDT_WDT_COMP_VERSION_1 localVal = hwp_wdt->wdt_comp_version_1;

    *wdtcomponentversion1 = localVal.bit_field.wdtcomponentversion1;
}

__STATIC_INLINE uint32_t wdt_wdtcomponentversion1_getf(void)
{
    return hwp_wdt->wdt_comp_version_1.bit_field.wdtcomponentversion1;
}
