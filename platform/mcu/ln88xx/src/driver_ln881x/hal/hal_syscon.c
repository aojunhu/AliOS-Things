...
{
    LL_SYSCON_PMUReg_Set(0x81042086);// (BUCK)  r_vtrim: bit[9:8]=0b01 //00: 1.195 / 01: 1.202  / 10: 1.210 / 11: 1.218
    LL_SYSCON_PMUCfg_Set(0x20006003);// o_digldo_norvdd: bit[10:8]=0b100; o_digldo_retvdd: bit[14:12]=0b001
