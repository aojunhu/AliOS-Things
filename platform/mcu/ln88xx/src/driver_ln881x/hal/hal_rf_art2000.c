...
#include "ll/ll_rf_art2000.h"
#include "ll/ll_phy_art2000.h"
...
{
    uint16_t regPLL_sdm_freq_low, regPLL_sdm_freq_high, value = (int)channel;

    if(value > 14){
        return;
    }

    value = (value << 1) | 0x00;  // BIT0 force on.
    ll_rf_art2000_reg_write(0, 0x11, value);

    switch(channel){
        case RF_CH_0:
            regPLL_sdm_freq_high = 0x3BAC;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_1:
            regPLL_sdm_freq_high = 0x3C4C;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_2:
            regPLL_sdm_freq_high = 0x3C6C;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_3:
            regPLL_sdm_freq_high = 0x3C8C;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_4:
            regPLL_sdm_freq_high = 0x3CAC;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_5:
            regPLL_sdm_freq_high = 0x3CCC;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_6:
            regPLL_sdm_freq_high = 0x3CEC;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_7:
            regPLL_sdm_freq_high = 0x3D0C;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_8:
            regPLL_sdm_freq_high = 0x3D2C;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_9:
            regPLL_sdm_freq_high = 0x3D4C;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_10:
            regPLL_sdm_freq_high = 0x3D6C;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_11:
            regPLL_sdm_freq_high = 0x3D8C;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_12:
            regPLL_sdm_freq_high = 0x3DAC;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_13:
            regPLL_sdm_freq_high = 0x3DCC;
            regPLL_sdm_freq_low = 0xCCCC;
            break;
        case RF_CH_14:
            regPLL_sdm_freq_high = 0x3E19;
            regPLL_sdm_freq_low = 0x9999;
            break;
        default:
            break;
    }
    ll_rf_art2000_reg_write(0, 0x43, regPLL_sdm_freq_low); // rfpll_sdm_freq_low
    ll_rf_art2000_reg_write(0, 0x44, regPLL_sdm_freq_high); // rfpll_sdm_freq_high
}
...
static void hal_rf_art2000_get_single_cal_value(pll_capbank_t *cal_value)
{
    ...
    ll_rf_art2000_reg_write(0, 0x01, 0x0010); // rfpll_single_cal_en
...
void hal_rf_art2000_set_single_cal_value(pll_capbank_t *cal_value)
{
    ...
    ll_rf_art2000_reg_write(0, 0x48, cal_value->reg16_val); // vco capbank p
    ll_rf_art2000_reg_write(0, 0x49, cal_value->reg17_val); // vco capbank n
}
