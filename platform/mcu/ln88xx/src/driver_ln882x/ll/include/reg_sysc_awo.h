...
typedef union
{
    ...
    struct
    {
        uint32_t    r_pad_pu_31_0       : 32 ; // 31 : 0
    } bit_field;
} t_sysc_awo_pad_pu_0;
...
typedef union
{
    ...
    struct
    {
        uint32_t                 r_pad_pu_34_32 :  3; /* 2: 0,                   pad pull up */
...
typedef union
{
    ...
    struct
    {
        uint32_t    r_pad_pd_31_0       : 32 ; // 31 : 0
    } bit_field;
} t_sysc_awo_pad_pd_0;
...
typedef union
{
    ...
    struct
    {
        uint32_t                 r_pad_pd_34_32 :  3; /* 2: 0,                  pad pull down*/
        uint32_t                     reserved_0 : 29; /*31: 3,                       RESERVED*/
    } bit_field;
} t_sysc_awo_pad_pd_1;
...
typedef union
{
    ...
    struct
    {
        uint32_t    r_pad_ds_0_31_0     : 32 ; // 31 : 0
    } bit_field;
} t_sysc_awo_pad_ds0_0;
...
typedef union
{
    ...
    struct
    {
        uint32_t    r_pad_ds_0_34_32    : 3  ; // 2  : 0
        uint32_t    reserved_0          : 29 ; // 31 : 3
    } bit_field;
} t_sysc_awo_pad_ds0_1;
...
typedef union
{
    ...
    struct
    {
        uint32_t    r_pad_ds_1_31_0     : 32 ; // 31 : 0
    } bit_field;
} t_sysc_awo_pad_ds1_0;
...
typedef union
{
    ...
    struct
    {
        uint32_t    r_pad_ds_1_34_32    : 3  ; // 2  : 0
        uint32_t    reserved_0          : 29 ; // 31 : 3
    } bit_field;
} t_sysc_awo_pad_ds1_1;
...
typedef union
{
    ...
    struct
    {
        uint32_t    r_pad_hp_31_0       : 32 ; // 31 : 0
    } bit_field;
} t_sysc_awo_pad_hp_0;
...
typedef union
{
    ...
    struct
    {
        uint32_t    xtal40m_tcal_reg_l  : 32 ; // 31 : 0
    } bit_field;
} t_sysc_awo_xtal40m_tcal_reg_l;
...
typedef union
{
    ...
    struct
    {
        uint32_t    xtal40m_tcal_reg_h  : 3  ; // 2  : 0
        uint32_t    xtal40m_tcode_sel   : 1  ; // 3  : 3
        uint32_t    xtal40m_tcal_code   : 4  ; // 7  : 4
        uint32_t    xtal40m_temp_code_i : 4  ; // 11 : 8
        uint32_t    reserved_0          : 20 ; // 31 : 12
    } bit_field;
} t_sysc_awo_xtal40m_tcal_reg_h;
...
typedef struct
{
    ...
    volatile        t_sysc_awo_pad_pu_0                      pad_pu_0                               ; // 0x44
    volatile        t_sysc_awo_pad_pu_1                      pad_pu_1                               ; // 0x48
    volatile        t_sysc_awo_pad_pd_0                      pad_pd_0                               ; // 0x4c
    volatile        t_sysc_awo_pad_pd_1                      pad_pd_1                               ; // 0x50
    volatile        t_sysc_awo_pad_ds0_0                     pad_ds0_0                              ; // 0x54
    volatile        t_sysc_awo_pad_ds0_1                     pad_ds0_1                              ; // 0x58
    volatile        t_sysc_awo_pad_ds1_0                     pad_ds1_0                              ; // 0x5c
    volatile        t_sysc_awo_pad_ds1_1                     pad_ds1_1                              ; // 0x60
    volatile        t_sysc_awo_pad_hp_0                      pad_hp_0                               ; // 0x64
    volatile        t_sysc_awo_pad_hp_1                      pad_hp_1                               ; // 0x68
    ...
    volatile        t_sysc_awo_xtal40m_tcal_reg_l            xtal40m_tcal_reg_l                     ; // 0x8c
    volatile        t_sysc_awo_xtal40m_tcal_reg_h            xtal40m_tcal_reg_h                     ; // 0x90
...
__STATIC_INLINE void sysc_awo_pad_pu_0_set( uint32_t value)
{
    hwp_sysc_awo->pad_pu_0.val = value;
}

__STATIC_INLINE void sysc_awo_r_pad_pu_31_0_setf( uint32_t r_pad_pu_31_0)
{
    hwp_sysc_awo->pad_pu_0.bit_field.r_pad_pu_31_0 = r_pad_pu_31_0;
}

__STATIC_INLINE void sysc_awo_r_pad_pu_34_32_setf( uint32_t r_pad_pu_34_32)
{
    hwp_sysc_awo->pad_pu_1.bit_field.r_pad_pu_34_32 = r_pad_pu_34_32;
}
__STATIC_INLINE uint32_t sysc_awo_r_pad_pu_34_32_getf(void)
{
    return hwp_sysc_awo->pad_pu_1.bit_field.r_pad_pu_34_32;
}
__STATIC_INLINE void sysc_awo_pad_pd_0_set( uint32_t value)
{
    hwp_sysc_awo->pad_pd_0.val = value;
}

__STATIC_INLINE void sysc_awo_r_pad_pd_31_0_setf( uint32_t r_pad_pd_31_0)
{
    hwp_sysc_awo->pad_pd_0.bit_field.r_pad_pd_31_0 = r_pad_pd_31_0;
}

__STATIC_INLINE void sysc_awo_r_pad_pd_34_32_setf( uint32_t r_pad_pd_34_32)
{
    hwp_sysc_awo->pad_pd_1.bit_field.r_pad_pd_34_32= r_pad_pd_34_32;
}
__STATIC_INLINE uint32_t sysc_awo_r_pad_pd_34_32_getf(void)
{
    return hwp_sysc_awo->pad_pd_1.bit_field.r_pad_pd_34_32;
}

__STATIC_INLINE void sysc_awo_pad_ds0_0_set( uint32_t value)
{
    hwp_sysc_awo->pad_ds0_0.val = value;
}

__STATIC_INLINE void sysc_awo_r_pad_ds_0_31_0_setf( uint32_t r_pad_ds_0_31_0)
{
    hwp_sysc_awo->pad_ds0_0.bit_field.r_pad_ds_0_31_0 = r_pad_ds_0_31_0;
}

__STATIC_INLINE void sysc_awo_pad_ds0_1_set( uint32_t value)
{
    hwp_sysc_awo->pad_ds0_1.val = value;
}

__STATIC_INLINE void sysc_awo_r_pad_ds_0_34_32_setf( uint8_t r_pad_ds_0_34_32)
{
    hwp_sysc_awo->pad_ds0_1.bit_field.r_pad_ds_0_34_32 = r_pad_ds_0_34_32;
}

__STATIC_INLINE void sysc_awo_pad_ds1_0_set( uint32_t value)
{
    hwp_sysc_awo->pad_ds1_0.val = value;
}

__STATIC_INLINE void sysc_awo_r_pad_ds_1_31_0_setf( uint32_t r_pad_ds_1_31_0)
{
    hwp_sysc_awo->pad_ds1_0.bit_field.r_pad_ds_1_31_0 = r_pad_ds_1_31_0;
}

__STATIC_INLINE void sysc_awo_pad_ds1_1_set( uint32_t value)
{
    hwp_sysc_awo->pad_ds1_1.val = value;
}

__STATIC_INLINE void sysc_awo_r_pad_ds_1_34_32_setf( uint8_t r_pad_ds_1_34_32)
{
    hwp_sysc_awo->pad_ds1_1.bit_field.r_pad_ds_1_34_32 = r_pad_ds_1_34_32;
}

__STATIC_INLINE void sysc_awo_pad_hp_0_set( uint32_t value)
{
    hwp_sysc_awo->pad_hp_0.val = value;
}

__STATIC_INLINE void sysc_awo_r_pad_hp_31_0_setf( uint32_t r_pad_hp_31_0)
{
    hwp_sysc_awo->pad_hp_0.bit_field.r_pad_hp_31_0 = r_pad_hp_31_0;
}

__STATIC_INLINE void sysc_awo_pad_hp_1_set( uint32_t value)
{
    hwp_sysc_awo->pad_hp_1.val = value;
}

__STATIC_INLINE void sysc_awo_r_pad_hp_34_32_setf( uint8_t r_pad_hp_34_32)
{
    hwp_sysc_awo->pad_hp_1.bit_field.r_pad_hp_34_32 = r_pad_hp_34_32;
}
...
__STATIC_INLINE void sysc_awo_xtal40m_tcal_reg_l_set( uint32_t value)
{
    hwp_sysc_awo->xtal40m_tcal_reg_l.val = value;
}

__STATIC_INLINE void sysc_awo_xtal40m_tcal_reg_l_setf( uint32_t xtal40m_tcal_reg_l)
{
    hwp_sysc_awo->xtal40m_tcal_reg_l.bit_field.xtal40m_tcal_reg_l = xtal40m_tcal_reg_l;
}

__STATIC_INLINE void sysc_awo_xtal40m_tcal_reg_h_set( uint32_t value)
{
    hwp_sysc_awo->xtal40m_tcal_reg_h.val = value;
}

__STATIC_INLINE void sysc_awo_xtal40m_temp_code_i_setf( uint8_t xtal40m_temp_code_i)
{
    hwp_sysc_awo->xtal40m_tcal_reg_h.bit_field.xtal40m_temp_code_i = xtal40m_temp_code_i;
}

__STATIC_INLINE void sysc_awo_xtal40m_tcode_sel_setf( uint8_t xtal40m_tcode_sel)
{
    hwp_sysc_awo->xtal40m_tcal_reg_h.bit_field.xtal40m_tcode_sel = xtal40m_tcode_sel;
}

__STATIC_INLINE void sysc_awo_xtal40m_tcal_reg_h_setf( uint8_t xtal40m_tcal_reg_h)
{
    hwp_sysc_awo->xtal40m_tcal_reg_h.bit_field.xtal40m_tcal_reg_h = xtal40m_tcal_reg_h;
}
...
__STATIC_INLINE uint32_t sysc_awo_pad_pu_0_get(void)
{
    return hwp_sysc_awo->pad_pu_0.val;
}

__STATIC_INLINE uint32_t sysc_awo_r_pad_pu_31_0_getf(void)
{
    return hwp_sysc_awo->pad_pu_0.bit_field.r_pad_pu_31_0;
}

__STATIC_INLINE uint32_t sysc_awo_pad_pd_0_get(void)
{
    return hwp_sysc_awo->pad_pd_0.val;
}

__STATIC_INLINE uint32_t sysc_awo_r_pad_pd_31_0_getf(void)
{
    return hwp_sysc_awo->pad_pd_0.bit_field.r_pad_pd_31_0;
}

__STATIC_INLINE uint32_t sysc_awo_pad_ds0_0_get(void)
{
    return hwp_sysc_awo->pad_ds0_0.val;
}

__STATIC_INLINE uint32_t sysc_awo_r_pad_ds_0_31_0_getf(void)
{
    return hwp_sysc_awo->pad_ds0_0.bit_field.r_pad_ds_0_31_0;
}

__STATIC_INLINE uint32_t sysc_awo_pad_ds0_1_get(void)
{
    return hwp_sysc_awo->pad_ds0_1.val;
}

__STATIC_INLINE uint8_t sysc_awo_r_pad_ds_0_34_32_getf(void)
{
    return hwp_sysc_awo->pad_ds0_1.bit_field.r_pad_ds_0_34_32;
}

__STATIC_INLINE uint32_t sysc_awo_pad_ds1_0_get(void)
{
    return hwp_sysc_awo->pad_ds1_0.val;
}

__STATIC_INLINE uint32_t sysc_awo_r_pad_ds_1_31_0_getf(void)
{
    return hwp_sysc_awo->pad_ds1_0.bit_field.r_pad_ds_1_31_0;
}

__STATIC_INLINE uint32_t sysc_awo_pad_ds1_1_get(void)
{
    return hwp_sysc_awo->pad_ds1_1.val;
}

__STATIC_INLINE uint8_t sysc_awo_r_pad_ds_1_34_32_getf(void)
{
    return hwp_sysc_awo->pad_ds1_1.bit_field.r_pad_ds_1_34_32;
}

__STATIC_INLINE uint32_t sysc_awo_pad_hp_0_get(void)
{
    return hwp_sysc_awo->pad_hp_0.val;
}

__STATIC_INLINE uint32_t sysc_awo_r_pad_hp_31_0_getf(void)
{
    return hwp_sysc_awo->pad_hp_0.bit_field.r_pad_hp_31_0;
}

__STATIC_INLINE uint32_t sysc_awo_pad_hp_1_get(void)
{
    return hwp_sysc_awo->pad_hp_1.val;
}

__STATIC_INLINE uint8_t sysc_awo_r_pad_hp_34_32_getf(void)
{
    return hwp_sysc_awo->pad_hp_1.bit_field.r_pad_hp_34_32;
}
...
__STATIC_INLINE uint32_t sysc_awo_xtal40m_tcal_reg_l_get(void)
{
    return hwp_sysc_awo->xtal40m_tcal_reg_l.val;
}

__STATIC_INLINE uint32_t sysc_awo_xtal40m_tcal_reg_l_getf(void)
{
    return hwp_sysc_awo->xtal40m_tcal_reg_l.bit_field.xtal40m_tcal_reg_l;
}

__STATIC_INLINE uint32_t sysc_awo_xtal40m_tcal_reg_h_get(void)
{
    return hwp_sysc_awo->xtal40m_tcal_reg_h.val;
}

__STATIC_INLINE uint8_t sysc_awo_xtal40m_temp_code_i_getf(void)
{
    return hwp_sysc_awo->xtal40m_tcal_reg_h.bit_field.xtal40m_temp_code_i;
}

__STATIC_INLINE uint8_t sysc_awo_xtal40m_tcal_code_getf(void)
{
    return hwp_sysc_awo->xtal40m_tcal_reg_h.bit_field.xtal40m_tcal_code;
}

__STATIC_INLINE uint8_t sysc_awo_xtal40m_tcode_sel_getf(void)
{
    return hwp_sysc_awo->xtal40m_tcal_reg_h.bit_field.xtal40m_tcode_sel;
}

__STATIC_INLINE uint8_t sysc_awo_xtal40m_tcal_reg_h_getf(void)
{
    return hwp_sysc_awo->xtal40m_tcal_reg_h.bit_field.xtal40m_tcal_reg_h;
}
...
__STATIC_INLINE void sysc_awo_xtal40m_tcal_reg_h_pack( uint8_t xtal40m_temp_code_i, uint8_t xtal40m_tcode_sel, uint8_t xtal40m_tcal_reg_h)
{
    hwp_sysc_awo->xtal40m_tcal_reg_h.val = ( \
                                    ((uint32_t )xtal40m_temp_code_i<< 8) \
                                  | ((uint32_t )xtal40m_tcode_sel << 3) \
                                  | ((uint32_t )xtal40m_tcal_reg_h) \
                                  );
}
...
__STATIC_INLINE void sysc_awo_xtal40m_tcal_reg_h_unpack( uint8_t * xtal40m_temp_code_i, uint8_t * xtal40m_tcal_code, uint8_t * xtal40m_tcode_sel, uint8_t * xtal40m_tcal_reg_h)
{
    t_sysc_awo_xtal40m_tcal_reg_h local_val = hwp_sysc_awo->xtal40m_tcal_reg_h;

    *xtal40m_temp_code_i= local_val.bit_field.xtal40m_temp_code_i;
    *xtal40m_tcal_code  = local_val.bit_field.xtal40m_tcal_code;
    *xtal40m_tcode_sel  = local_val.bit_field.xtal40m_tcode_sel;
    *xtal40m_tcal_reg_h = local_val.bit_field.xtal40m_tcal_reg_h;
}
