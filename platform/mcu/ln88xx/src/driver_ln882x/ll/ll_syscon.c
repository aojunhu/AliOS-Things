...
void LL_SYSCON_GPIO_PullUp(GPIO_Num gpio_num)
{
    ...
    if(gpio_num <= 31)
    {
        //Set bit[gpio_num] in pad_pu_0
        value = sysc_awo_r_pad_pu_31_0_getf();
        value |= (1 << gpio_num);
        sysc_awo_r_pad_pu_31_0_setf(value);

        //Clear bit[gpio_num] in pad_pd_0
        value = sysc_awo_r_pad_pd_31_0_getf();
        value &= ~(1 << gpio_num);
        sysc_awo_r_pad_pd_31_0_setf(value);
    }
    else if((gpio_num >= 32) && (gpio_num <= 34))
    {
        //Set bit[gpio_num - 32] in pad_pu_1
        value = sysc_awo_r_pad_pu_34_32_getf();
        value |= (1 << (gpio_num - 32));
        sysc_awo_r_pad_pu_34_32_setf(value);

        //Clear bit[gpio_num - 32] in pad_pd_1
        value = sysc_awo_r_pad_pd_34_32_getf();
        value &= ~(1 << (gpio_num - 32));
        sysc_awo_r_pad_pd_34_32_setf(value);
    }
}
...
void LL_SYSCON_GPIO_PullDown(GPIO_Num gpio_num)
{
    ...
    if(gpio_num <= 31)
    {
        //Clear bit[gpio_num] in pad_pu_0
        value = sysc_awo_r_pad_pu_31_0_getf();
        value &= ~(1 << gpio_num);
        sysc_awo_r_pad_pu_31_0_setf(value);

        //Set bit[gpio_num] in pad_pd_0
        value = sysc_awo_r_pad_pd_31_0_getf();
        value |= (1 << gpio_num);
        sysc_awo_r_pad_pd_31_0_setf(value);
    }
    ...
    {
        //Clear bit[gpio_num - 32] in pad_pu_1
        value = sysc_awo_r_pad_pu_34_32_getf();
        value &= ~(1 << (gpio_num - 32));
        sysc_awo_r_pad_pu_34_32_setf(value);

        //Set bit[gpio_num - 32] in pad_pd_1
        value = sysc_awo_r_pad_pd_34_32_getf();
        value |= (1 << (gpio_num - 32));
        sysc_awo_r_pad_pd_34_32_setf(value);
    }
...
{
    sysc_cmp_r_io_dsel_setf(bitmap);
}
